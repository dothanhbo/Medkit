            ...
            child: Column(children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const PopularDisease()));
                },
                child: Container(
                  height: 100,
                    ...
                    children: <Widget>[
                      Pharmacist(
                        pharmacistModel: PharmacistModel(
                          image:
                              pharmacist1, // Replace with the actual image path
                      ...
                      Pharmacist(
                        pharmacistModel: PharmacistModel(
                          image:
                              pharmacist2, // Replace with the actual image path
                          name:
                              'Anderson', // Replace with the actual name
                      ...
                      Pharmacist(
                        pharmacistModel: PharmacistModel(
                          image:
                              pharmacist3, // Replace with the actual image path
                          name:
                              'Samuel Jackson', // Replace with the actual name
                      ...
                      Pharmacist(
                        pharmacistModel: PharmacistModel(
                          image:
                              pharmacist4, // Replace with the actual image path
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 20.0),
                  Box(
                    titleString: 'Using History',
                    onPressedCallback: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => const UsingHistoryPage()));
                    },
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  Box(
                    titleString: 'My Family Box',
                    onPressedCallback: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => const MyBox()));
                    },
                  ),
